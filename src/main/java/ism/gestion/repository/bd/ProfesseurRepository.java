...
public class ProfesseurRepository extends MysqlDb implements IProfesseurRepository{
    ...
    private final String SQL_SELECT_CLASS_PROF="SELECT * FROM classe c ,prof_classe pc WHERE c.id=pc.classe_id AND pc.prof_id=?";
    private final String SQL_INSERT_ClASS_PROF="INSERT INTO `prof_classe`(`classe_id`, `prof_id`) VALUES (?,?)";
